...
fun Context.getStringArrRes(@ArrayRes id: Int): Array<out String> {
    return this.resources.getStringArray(id)
}

fun Context.getIntegerRes(@IntegerRes id: Int): Int {
    return this.resources.getInteger(id)
}

fun Context.getIntegerArrRes(@ArrayRes id: Int): IntArray {
    return this.resources.getIntArray(id)
}

fun Context.getDimensionRes(@DimenRes id: Int): Float {
    return this.resources.getDimension(id)
}

fun Context.getDimensionPixelSizeRes(@DimenRes id: Int): Int {
    return this.resources.getDimensionPixelSize(id)
}

fun Context.obtainTypedArray(@ArrayRes resID: Int): TypedArray {
    return this.resources.obtainTypedArray(resID)
}

fun Context.obtainAttributes(set: AttributeSet? = null, attrs: IntArray?? = null): TypedArray {
